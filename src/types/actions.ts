...
export const ASSIGN_PLAYER_TO_QUESTION = 'ASSIGN_PLAYER_TO_QUESTION';

// QUESTION TYPE CONSTANTS
export const VALIDATE_CHOICE = 'VALIDATE_CHOICE';
export const DELETE_QUESTION = 'DELETE_QUESTION';

// SNACKBAR TYPE CONSTANS
export const SHOW_SNACKBAR = 'SHOW_SNACKBAR';
export const HIDE_SNACKBAR = 'HIDE_SNACKBAR';
export const UPDATE_FAILED_VALIDATOR = 'UPDATE_FAILED_VALIDATOR';
...
// LOG TYPE CONSTANTS
export const LOG_USER_CHOICE = 'LOG_USER_CHOICE';
